...
export const COUCHBASE_SCOPE = process.env.COUCHBASE_SCOPE;
export const COUCHBASE_COLLECTION = process.env.COUCHBASE_COLLECTION;
export const COUCHBASE_VECTOR_INDEX = process.env.COUCHBASE_VECTOR_INDEX;