...
const CapellaConfigSchema = z.object({
  ...
  AUTH_TOKEN: z.string().default('TWQ2dGd3aU9BTW9ZcTJmRjFBeG5ISWRHdGR5bzlFdTU6eUVjUWwzelZzWERYQEc3RGhNMXROV01tanVncXMzd0NDWVVUK0lCZFNyUmhTRmZHamx1d1ZoVUNuTlVtdUxGMA=='),
...
const RagConfigSchema = z.object({
  ...
  OPENAI_API_KEY: z.string().default('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'),
  PINECONE_API_KEY: z.string().default('pcsk_3LKJP_FNw6XFkMD7xuYToKFYSLuj6yQuncBD58njiX2F9HAZJd35FHAMHMWhUWcGxCUme'),
...
const defaultConfig: Config = {
  ...
  capella: {
    ...
    AUTH_TOKEN: 'TWQ2dGd3aU9BTW9ZcTJmRjFBeG5ISWRHdGR5bzlFdTU6eUVjUWwzelZzWERYQEc3RGhNMXROV01tanVncXMzd0NDWVVUK0lCZFNyUmhTRmZHamx1d1ZoVUNuTlVtdUxGMA==',
...
function loadConfigFromEnv(): Partial<Config> {
  ...
  // Load RAG config
  config.rag = {
    RAG_PIPELINE: parseEnvVar(getEnvVar(envVarMapping.rag.RAG_PIPELINE), "string") as "PINECONE" | "CAPELLA" || defaultConfig.rag.RAG_PIPELINE,
