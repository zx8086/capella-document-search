...
function getEnvVar(key: string): string | undefined {
  ...
  if (typeof Bun !== "undefined" && Bun.env?.[publicKey])
    return Bun.env[publicKey];
...
function loadConfigFromEnv(): Partial<BackendConfig> {
  ...
  config.application = {
    ...
    LOG_MAX_SIZE:
      (parseEnvVar(
        getEnvVar(envVarMapping.application.LOG_MAX_SIZE),
        "string",
      ) as string) || defaultConfig.application.LOG_MAX_SIZE,
    LOG_MAX_FILES:
      (parseEnvVar(
        getEnvVar(envVarMapping.application.LOG_MAX_FILES),
        "string",
      ) as string) || defaultConfig.application.LOG_MAX_FILES,
    GRAPHQL_ENDPOINT:
      (parseEnvVar(
        getEnvVar(envVarMapping.application.GRAPHQL_ENDPOINT),
        "string",
      ) as string) || defaultConfig.application.GRAPHQL_ENDPOINT,
    DB_DATA_DIR:
      (parseEnvVar(
        getEnvVar(envVarMapping.application.DB_DATA_DIR),
        "string",
      ) as string) || defaultConfig.application.DB_DATA_DIR,
    ENABLE_FILE_LOGGING:
      (parseEnvVar(
  ...
  config.capella = {
    API_BASE_URL:
      (parseEnvVar(
        getEnvVar(envVarMapping.capella.API_BASE_URL),
        "string",
      ) as string) || defaultConfig.capella.API_BASE_URL,
    ORG_ID:
      (parseEnvVar(
        getEnvVar(envVarMapping.capella.ORG_ID),
        "string",
      ) as string) || defaultConfig.capella.ORG_ID,
    PROJECT_ID:
      (parseEnvVar(
        getEnvVar(envVarMapping.capella.PROJECT_ID),
        "string",
      ) as string) || defaultConfig.capella.PROJECT_ID,
    CLUSTER_ID:
      (parseEnvVar(
        getEnvVar(envVarMapping.capella.CLUSTER_ID),
        "string",
      ) as string) || defaultConfig.capella.CLUSTER_ID,
    BUCKET_ID:
      (parseEnvVar(
        getEnvVar(envVarMapping.capella.BUCKET_ID),
        "string",
      ) as string) || defaultConfig.capella.BUCKET_ID,
    AUTH_TOKEN:
      (parseEnvVar(
        getEnvVar(envVarMapping.capella.AUTH_TOKEN),
        "string",
      ) as string) || defaultConfig.capella.AUTH_TOKEN,
    URL:
      (parseEnvVar(getEnvVar(envVarMapping.capella.URL), "string") as string) ||
      defaultConfig.capella.URL,
    USERNAME:
      (parseEnvVar(
        getEnvVar(envVarMapping.capella.USERNAME),
        "string",
      ) as string) || defaultConfig.capella.USERNAME,
    PASSWORD:
      (parseEnvVar(
        getEnvVar(envVarMapping.capella.PASSWORD),
        "string",
      ) as string) || defaultConfig.capella.PASSWORD,
    BUCKET:
      (parseEnvVar(
        getEnvVar(envVarMapping.capella.BUCKET),
        "string",
      ) as string) || defaultConfig.capella.BUCKET,
    SCOPE:
      (parseEnvVar(
        getEnvVar(envVarMapping.capella.SCOPE),
        "string",
      ) as string) || defaultConfig.capella.SCOPE,
    COLLECTION:
      (parseEnvVar(
        getEnvVar(envVarMapping.capella.COLLECTION),
        "string",
      ) as string) || defaultConfig.capella.COLLECTION,
    VECTOR_INDEX:
      (parseEnvVar(
        getEnvVar(envVarMapping.capella.VECTOR_INDEX),
        "string",
      ) as string) || defaultConfig.capella.VECTOR_INDEX,
  };
  ...
  config.openTelemetry = {
    SERVICE_NAME:
      (parseEnvVar(
        getEnvVar(envVarMapping.openTelemetry.SERVICE_NAME),
        "string",
      ) as string) || defaultConfig.openTelemetry.SERVICE_NAME,
    SERVICE_VERSION:
      (parseEnvVar(
        getEnvVar(envVarMapping.openTelemetry.SERVICE_VERSION),
        "string",
      ) as string) || defaultConfig.openTelemetry.SERVICE_VERSION,
    DEPLOYMENT_ENVIRONMENT:
      (parseEnvVar(
        getEnvVar(envVarMapping.openTelemetry.DEPLOYMENT_ENVIRONMENT),
        "string",
      ) as "development" | "staging" | "production") ||
      defaultConfig.openTelemetry.DEPLOYMENT_ENVIRONMENT,
    TRACES_ENDPOINT:
      (parseEnvVar(
        getEnvVar(envVarMapping.openTelemetry.TRACES_ENDPOINT),
        "string",
      ) as string) || defaultConfig.openTelemetry.TRACES_ENDPOINT,
    METRICS_ENDPOINT:
      (parseEnvVar(
        getEnvVar(envVarMapping.openTelemetry.METRICS_ENDPOINT),
        "string",
      ) as string) || defaultConfig.openTelemetry.METRICS_ENDPOINT,
    LOGS_ENDPOINT:
      (parseEnvVar(
        getEnvVar(envVarMapping.openTelemetry.LOGS_ENDPOINT),
        "string",
      ) as string) || defaultConfig.openTelemetry.LOGS_ENDPOINT,
  ...
  config.rag = {
    ...
    OPENAI_API_KEY:
      (parseEnvVar(
        getEnvVar(envVarMapping.rag.OPENAI_API_KEY),
        "string",
      ) as string) || defaultConfig.rag.OPENAI_API_KEY,
    PINECONE_API_KEY:
      (parseEnvVar(
        getEnvVar(envVarMapping.rag.PINECONE_API_KEY),
        "string",
      ) as string) || defaultConfig.rag.PINECONE_API_KEY,
    PINECONE_INDEX_NAME:
      (parseEnvVar(
        getEnvVar(envVarMapping.rag.PINECONE_INDEX_NAME),
        "string",
      ) as string) || defaultConfig.rag.PINECONE_INDEX_NAME,
    PINECONE_NAMESPACE:
      (parseEnvVar(
        getEnvVar(envVarMapping.rag.PINECONE_NAMESPACE),
        "string",
      ) as string) || defaultConfig.rag.PINECONE_NAMESPACE,
    AWS_REGION:
      (parseEnvVar(
        getEnvVar(envVarMapping.rag.AWS_REGION),
        "string",
      ) as string) || defaultConfig.rag.AWS_REGION,
    AWS_ACCESS_KEY_ID:
      (parseEnvVar(
        getEnvVar(envVarMapping.rag.AWS_ACCESS_KEY_ID),
        "string",
      ) as string) || defaultConfig.rag.AWS_ACCESS_KEY_ID,
    AWS_SECRET_ACCESS_KEY:
      (parseEnvVar(
        getEnvVar(envVarMapping.rag.AWS_SECRET_ACCESS_KEY),
        "string",
      ) as string) || defaultConfig.rag.AWS_SECRET_ACCESS_KEY,
    AWS_BEARER_TOKEN_BEDROCK:
      (parseEnvVar(
        getEnvVar(envVarMapping.rag.AWS_BEARER_TOKEN_BEDROCK),
        "string",
      ) as string) || defaultConfig.rag.AWS_BEARER_TOKEN_BEDROCK,
    BEDROCK_EMBEDDING_MODEL:
      (parseEnvVar(
        getEnvVar(envVarMapping.rag.BEDROCK_EMBEDDING_MODEL),
        "string",
      ) as string) || defaultConfig.rag.BEDROCK_EMBEDDING_MODEL,
    BEDROCK_CHAT_MODEL:
      (parseEnvVar(
        getEnvVar(envVarMapping.rag.BEDROCK_CHAT_MODEL),
        "string",
      ) as string) || defaultConfig.rag.BEDROCK_CHAT_MODEL,
    KNOWLEDGE_BASE_ID:
      (parseEnvVar(
